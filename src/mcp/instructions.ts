...
export const SERVER_INSTRUCTIONS = [
  ...
  "When waiting on peers or expecting a reply, call pull_messages with wait_ms (max 30000): it blocks until a message is published — push wake-up, not polling — so loop it rather than sleeping.",
